...
class coursesController extends Controller
{
    ...
    function getCoursesData(){
        $resultData=json_encode(courseModel::orderBy('id','desc')->get());
        return $resultData;
    }
    ...
    function updateCoursesData(Request $req){
 ...
 'course_fee'=>$course_fee,'course_totalenroll'=> $course_totalenroll,'course_totalclass'=> $course_totalclass,
 'course_link'=>$course_link,'course_img'=>$course_img]);
     ...
     function CoursesAdd(Request $req){
        ...
        $result=courseModel::insert(['course_name'=> $course_name,'course_des'=> $course_des,
        'course_fee'=>$course_fee,'course_totalenroll'=> $course_totalenroll,'course_totalclass'=> $course_totalclass,
        'course_link'=>$course_link,'course_img'=>$course_img]);
